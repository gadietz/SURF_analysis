...
regressor = LogisticRegressionCV(cv = 10, solver='lbfgs', class_weight='balanced')
...
#print("Test Fl Score: ", metrics.f1_score(y_test, y_pred))
print("Intercept: ", regressor.intercept_[0])
print("Coefficients: ")

coefs_name = ['Congruency', 'Response', \
              'Previous Congruency', 'Previous Response', \
              'Average of Previous RTs']
counter = 0
for coef in regressor.coef_[0]:
    print("   ", coefs_name[counter], ": ", coef, sep="")
    counter += 1
